...
function MentorGuidelines() {
  ...
  return (
    <>
      <Navbar />
      <div className="p-8 max-w-4xl mx-auto text-fg">
        <h1 className="text-3xl font-bold mb-2">Clarior – Mentor Terms &amp; Guidelines</h1>
        <p className="text-muted mb-8">Clarior is built on trust. Please read carefully.</p>
        ...
        <div className="space-y-8">
          <section className="bg-surface border-border border rounded-2xl p-6 shadow-sm">
            ...
            <ul className="list-disc pl-6 text-fg space-y-1">
          ...
          <section className="bg-surface border-border border rounded-2xl p-6 shadow-sm">
            ...
            <p className="text-fg mb-2">If any of the following occurs:</p>
            <ul className="list-disc pl-6 text-fg space-y-1">
          ...
          <section className="bg-surface border-border border rounded-2xl p-6 shadow-sm">
            ...
            <ol className="list-decimal pl-6 text-fg space-y-1">
